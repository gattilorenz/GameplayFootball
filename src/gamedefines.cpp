...
std::string GetRoleName(e_PlayerRole playerRole) {
    switch (playerRole) {
        ...
        case e_PlayerRole_CB: return "Verdediger";
        case e_PlayerRole_LB: return "Verdediger";
        case e_PlayerRole_RB: return "Verdediger";
        case e_PlayerRole_DM: return "Middenvelder";
...
std::string GetRoleNameShort(e_PlayerRole playerRole) {
    switch (playerRole) {
        case e_PlayerRole_GK: return "K";
        case e_PlayerRole_CB: return "V";
        case e_PlayerRole_LB: return "V";
        case e_PlayerRole_RB: return "V";
        case e_PlayerRole_DM: return "M";
